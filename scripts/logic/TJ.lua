...
TJ_ENTRY_FISH:connect_one_way_entrance("TJ_ENTRY_FISH_to_TJ_FISH_ENTRY",TJ_FISH_ENTRY,true)
TJ_ENTRY_BOULDER:connect_one_way_entrance("TJ_ENTRY_BOULDER_to_TJ_BOULDER_ENTRY",TJ_BOULDER_ENTRY,true)
TJ_MUSHROOM_ENTRY:connect_one_way_entrance("TJ_MUSHROOM_ENTRY_to_TJ_ENTRY_MUSHROOM",TJ_ENTRY_MUSHROOM,true)
TJ_FISH_ENTRY:connect_one_way_entrance("TJ_FISH_ENTRY_to_TJ_ENTRY_FISH",TJ_ENTRY_FISH,true)
TJ_FISH_TENT:connect_one_way_entrance("TJ_FISH_TENT_to_TJ_TENT_FISH",TJ_TENT_FISH,true)
TJ_TENT_FISH:connect_one_way_entrance("TJ_TENT_FISH_to_TJ_FISH_TENT",TJ_FISH_TENT,true)
TJ_TENT_BOULDER:connect_one_way_entrance("TJ_TENT_BOULDER_to_TJ_BOULDER_TENT",TJ_BOULDER_TENT,true)
TJ_BOULDER_ENTRY:connect_one_way_entrance("TJ_BOULDER_ENTRY_to_TJ_ENTRY_BOULDER",TJ_ENTRY_BOULDER,true)
TJ_BOULDER_TENT:connect_one_way_entrance("TJ_BOULDER_TENT_to_TJ_TENT_BOULDER",TJ_TENT_BOULDER,true)
...
-- Boulder Room
TJ_BOULDER_ENTRY:connect_one_way_entrance("TJ_BOULDER_ENTRY_to_TJ_BOULDER_TENT",TJ_BOULDER_TENT,function()
    result = any(
...
TJ_BOULDER_TENT:connect_one_way_entrance("TJ_BOULDER_TENT_to_TJ_BOULDER_ENTRY",TJ_BOULDER_ENTRY,function()
    result = any(
                Eval_Logic((CanSwim()),0),
                Eval_Logic((CanSwim() or ((IJ() or HasHoop()) and HasFlyer())),1),
