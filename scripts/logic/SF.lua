...
SF_FACTORY_WHEEL_BOTTOM:connect_one_way_entrance("SF_ENTRY_to_SF_FACTORY_RC_CAR",SF_FACTORY_RC_CAR,true)
SF_FACTORY_RC_CAR:connect_one_way_entrance("SF_ENTRY_to_SF_FACTORY_OUTSIDE",SF_FACTORY_OUTSIDE,true)
SF_FACTORY_RC_CAR:connect_one_way_entrance("SF_ENTRY_to_SF_FACTORY_WHEEL_BOTTOM",SF_FACTORY_WHEEL_BOTTOM,true)
